...
class ArticleControllerTest {
    ...
    @Test
    public void nothing_requestingArticleView_returnRedirectLoginPage() throws Exception {
        //given
        long articleId = 1L;
        //when&then
    ...
    @WithMockUser //컨트롤러에서 인증정보를 받아서 추가로 수행하는것이 없을때 사용하기 좋다
    ...
    @WithUserDetails(value = "hsmTest", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION) //BeanName 생략 가능, 하나만 있기 때문
